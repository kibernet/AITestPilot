...
- release evidence index, exporting a machine-readable source-manifest summary for CI, portal handoff, and audit consumers, including field-level coverage for 113 semantic fields across the primary release evidence manifests plus field-level definition and source script SHA256 binding plus source manifest SHA256 hash set binding.
