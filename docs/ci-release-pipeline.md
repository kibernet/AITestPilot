...
- production external evidence action queue probe, proving the operator queue preserves the pending local-mail action before post-dispatch evidence, reduces tracked work to the three external evidence areas after post-dispatch evidence, and exposes owner response bundle directory/zip auto-acceptance commands without sending mail or accepting evidence.
