...
- release progress notification remaining-work snapshot probe, independently verifying the outbox snapshot against owner input, driver readiness, Lua readiness, and the returned-evidence inbox while preserving the local mail boundary.
