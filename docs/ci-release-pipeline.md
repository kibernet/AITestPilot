...
- production external evidence action queue probe, proving the operator queue preserves the pending local-mail action before post-dispatch evidence and reduces tracked work to the three external evidence areas after post-dispatch evidence without sending mail or accepting evidence.
