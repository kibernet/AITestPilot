...
- release risk policy manifest proving package release is blocked unless AI exploration, high-risk graph, driver evidence, Lua evidence, live endpoint policy, CI provider controls, and production handoff evidence are explicitly accepted.
