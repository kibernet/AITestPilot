...
- release risk policy manifest proving package release is blocked unless AI exploration, high-risk graph, driver evidence, Lua evidence, live endpoint policy and accepted-contract proof, CI provider controls, production handoff evidence, production handoff preflight contract evidence, production external evidence acceptance contract/failure evidence, local mail authorization readiness boundaries, owner unblock packaging and contract proof, owner input request packaging, owner contact external intake proof, owner send dry-run proof, owner response bundle proof, owner response bundle kit evidence, release progress notification outbox evidence, mail-helper auth-status parsing proof, progress-notification confirmation/receipt/dispatch-intake/local-workflow proof, and hard-mode failure/success-contract evidence are explicitly accepted.
