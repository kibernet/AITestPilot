...
- Release-gated machine-readable release evidence index for CI, portal handoff, and audit consumers, with 129 semantic field checks, a source manifest SHA256 hash set, and a six-scenario field coverage probe that protects the latest bundle from pollution while preserving no-mail, no-real-host-evidence, and no-fixture-promotion boundaries.
