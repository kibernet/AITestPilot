...
if ($null -ne $productionLuaPatchEvidenceKitProbeManifest) {
    Add-ReleaseCheck "production_lua_patch_evidence_kit_probe" `
        ($productionLuaPatchEvidenceKitProbeManifest.status -eq "PASS" -and
            ...
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportHelperGenerated -and
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportHelperRequiresProductionLuaPatchedReadiness -and
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportHelperRequiresRealHostProjectEvidence -and
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportHelperRejectedTemplateEvidence -and
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportHelperRejectedFixtureEvidence -and
            [bool]$productionLuaPatchEvidenceKitProbeManifest.exportRejectionReadinessRejectedCurrentTemplate -and
...
if ($null -ne $productionHandoffExportManifest) {
    Add-ReleaseCheck "production_handoff_export" `
        ($productionHandoffExportManifest.status -eq "PASS" -and
            ...
            [bool]$productionHandoffExportManifest.semanticPreflightProbeUnsafeOwnerResponseBundleZipRejected -and
            [bool]$productionHandoffExportManifest.semanticPreflightProbeExtraPayloadBundleRejected -and
            [bool]$productionHandoffExportManifest.semanticPreflightProbeNestedPayloadBundleZipRejected -and
            [int]$productionHandoffExportManifest.semanticPreflightProbeOwnerResponseBundleZipCaseCount -eq 6 -and
            [int]$productionHandoffExportManifest.semanticPreflightProbeOwnerResponseBundleZipSafeCaseCount -eq 5 -and
            [int]$productionHandoffExportManifest.semanticPreflightProbeOwnerResponseBundleZipUnsafeCaseCount -eq 1 -and
            [int]$productionHandoffExportManifest.semanticPreflightProbePayloadShapeRejectedCaseCount -eq 2 -and
            ...
            [bool](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusIncluded" $false) -and
            [bool](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusContentValidated" $false) -and
            ...
            -not [bool](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusSemanticPreflightRun" $true) -and
            -not [bool](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusReadyForAcceptanceCandidate" $true) -and
            [int](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusPendingOwnerPacketCount" 0) -eq 3 -and
            [int](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusRemainingMissingFileCount" 0) -eq 9 -and
            [int](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusRemainingBlockingReasonCount" 0) -eq 11 -and
            -not [bool](Get-JsonValue $productionHandoffExportManifest "ownerReturnBundleStatusAcceptanceRun" $true) -and
            ...
            [int](Get-JsonValue $productionHandoffExportManifest "operatorActionQueueItemStatusCommandCount" 0) -eq 3 -and
...
if ($null -ne $productionExternalEvidenceActionQueueManifest) {
    ...
    $productionExternalEvidenceActionQueuePendingStateAccepted = (
        ...
        -not ([bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "progressNotificationEmailSent" $true)) -and
        [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "localProgressMailRemainingActionCount" 0) -eq 1 -and
        [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "trackedRemainingWorkItemCount" 0) -eq 4 -and
        [string](Get-JsonValue $productionExternalEvidenceActionQueueManifest "productionOutputBoundary" "") -eq "production_external_evidence_action_queue_pending_progress_mail"
    )
    $productionExternalEvidenceActionQueuePostDispatchStateAccepted = (
        ...
        [bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "progressNotificationEmailSent" $false) -and
        [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "localProgressMailRemainingActionCount" 1) -eq 0 -and
        [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "trackedRemainingWorkItemCount" 0) -eq 3 -and
        [string](Get-JsonValue $productionExternalEvidenceActionQueueManifest "productionOutputBoundary" "") -eq "production_external_evidence_action_queue_after_progress_mail"
    )
    ...
    Add-ReleaseCheck "production_external_evidence_action_queue" `
        ($productionExternalEvidenceActionQueueManifest.status -eq "PASS" -and
            $productionExternalEvidenceActionQueueManifest.schemaVersion -eq "aitestpilot.production_external_evidence_action_queue.v1" -and
            ...
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "externalRemainingWorkItemCount" 0) -eq 3 -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "externalRemainingMissingFileCount" 0) -eq 9 -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "externalRemainingBlockingReasonCount" 0) -eq 11 -and
            ...
            ([string](Get-JsonValue $productionExternalEvidenceActionQueueManifest "ownerResponseBundleZipEnvironmentVariable" "")) -eq "AITESTPILOT_OWNER_RESPONSE_BUNDLE_ZIP_PATH" -and
            ([string](Get-JsonValue $productionExternalEvidenceActionQueueManifest "ownerResponseBundleDirEnvironmentVariable" "")) -eq "AITESTPILOT_OWNER_RESPONSE_BUNDLE_DIR" -and
            $productionExternalEvidenceActionQueueItemStatusCommandCount -eq 3 -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "productionDriverEvidenceExportHelperItemCount" 0) -eq 1 -and
            ...
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "productionLuaEvidenceExportHelperItemCount" 0) -eq 1 -and
            ...
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "liveModelSmokeEvidenceExportHelperItemCount" 0) -eq 1 -and
            ...
            -not ([bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "releasePipelineSendsEmail" $true)) -and
            -not ([bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "realHostProjectEvidenceAccepted" $true)) -and
            -not ([bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "externalEvidenceAccepted" $true)) -and
            -not ([bool](Get-JsonValue $productionExternalEvidenceActionQueueManifest "fixtureEvidencePromoted" $true)) -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "checkCount" 0) -eq 10 -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueManifest "failedCheckCount" 1) -eq 0) `
        "Production external evidence action queue must refresh the canonical operator queue, keep pending-mail and post-dispatch states distinct, expose semantic-preflight-before-auto-acceptance commands, and preserve external evidence blockers."

    Test-ListedFiles $productionExternalEvidenceActionQueueManifest "production_external_evidence_action_queue"
}
...
if ($null -ne $productionExternalEvidenceActionQueueProbeManifest) {
    Add-ReleaseCheck "production_external_evidence_action_queue_probe" `
        ($productionExternalEvidenceActionQueueProbeManifest.status -eq "PASS" -and
            ...
            [int](Get-JsonValue $productionExternalEvidenceActionQueueProbeManifest "pendingQueueItemStatusCommandCount" 0) -eq 3 -and
            [int](Get-JsonValue $productionExternalEvidenceActionQueueProbeManifest "postDispatchQueueItemStatusCommandCount" 0) -eq 3 -and
            ...
            [int]$productionExternalEvidenceActionQueueProbeManifest.checkCount -eq 10 -and
...
if ($null -ne $productionExternalEvidenceSemanticPreflightProbeManifest) {
    Add-ReleaseCheck "production_external_evidence_semantic_preflight_probe" `
        ($productionExternalEvidenceSemanticPreflightProbeManifest.status -eq "PASS" -and
            ...
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.caseCount -eq 12 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.completeCandidateCaseCount -eq 4 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.rejectedCaseCount -eq 8 -and
            ...
            [bool]$productionExternalEvidenceSemanticPreflightProbeManifest.unsafeOwnerResponseBundleZipRejected -and
            ...
            [bool]$productionExternalEvidenceSemanticPreflightProbeManifest.extraPayloadBundleRejected -and
            [bool]$productionExternalEvidenceSemanticPreflightProbeManifest.nestedPayloadBundleZipRejected -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.ownerResponseBundleZipCaseCount -eq 6 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.ownerResponseBundleZipSafeCaseCount -eq 5 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.ownerResponseBundleZipUnsafeCaseCount -eq 1 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.payloadShapeRejectedCaseCount -eq 2 -and
            ...
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.ownerRepairRouteCaseCount -ge 3 -and
            ...
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.checkCount -eq 14 -and
            [int]$productionExternalEvidenceSemanticPreflightProbeManifest.failedCheckCount -eq 0) `
        "Production external evidence semantic preflight probe must reject missing, partial, fixture/template-shaped, extra-payload, and nested-payload returned owner bundle directories and zips before acceptance, while resolving expected and arbitrary single-directory zip wrappers without sending mail or promoting fixtures."
...
if ($null -ne $productionExternalEvidenceAutoAcceptanceProbeManifest) {
    Add-ReleaseCheck "production_external_evidence_auto_acceptance_probe" `
        ($productionExternalEvidenceAutoAcceptanceProbeManifest.status -eq "PASS" -and
            ...
            [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.ownerResponseBundleZipInspected -and
            ...
            [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleRejected -and
            $productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleStatus -eq "FAIL" -and
            [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleAllEvidenceReady -and
            [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleSemanticPreflightGateRun -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleSemanticPreflightGatePassed -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleSemanticPreflightReadyForAcceptanceCandidate -and
            [int]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleSemanticPreflightPayloadShapeViolationCount -gt 0 -and
            [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleSemanticPreflightGateBlockedAcceptance -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleAcceptanceRun -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleAllExternalEvidenceAccepted -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleRealHostProjectEvidenceAccepted -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleEmailSent -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.extraPayloadOwnerResponseBundleFixtureEvidencePromoted -and
            ...
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.unsafeOwnerResponseBundleZipSafe -and
            [int]$productionExternalEvidenceAutoAcceptanceProbeManifest.unsafeOwnerResponseBundleZipUnsafeEntryCount -gt 0 -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.unsafeOwnerResponseBundleZipRealHostProjectEvidenceAccepted -and
            -not [bool]$productionExternalEvidenceAutoAcceptanceProbeManifest.unsafeOwnerResponseBundleZipFixtureEvidencePromoted -and
...
if ($null -ne $releaseRiskPolicyManifest) {
    ...
    Add-ReleaseCheck "release_risk_policy" `
        ($releaseRiskPolicyManifest.status -eq "PASS" -and
            ...
            [bool]$releaseRiskPolicyManifest.productionLuaEvidenceKitExportHelperAccepted -and
            ...
            [bool]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeUnsafeOwnerResponseBundleZipRejected -and
            [bool]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeExtraPayloadBundleRejected -and
            [bool]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeNestedPayloadBundleZipRejected -and
            [int]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeOwnerResponseBundleZipCaseCount -eq 6 -and
            [int]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeOwnerResponseBundleZipSafeCaseCount -eq 5 -and
            [int]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbeOwnerResponseBundleZipUnsafeCaseCount -eq 1 -and
            [int]$releaseRiskPolicyManifest.productionHandoffExportSemanticPreflightProbePayloadShapeRejectedCaseCount -eq 2 -and
            ...
            [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusIncluded" $false) -and
            [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusContentValidated" $false) -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusPath" "")).Contains("operator-actions\production-external-evidence-owner-return-bundle-status.md") -and
            (Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusReadinessStatus" "") -eq "PENDING_EXTERNAL_EVIDENCE" -and
            (Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusNextRequiredAction" "") -eq "collect_owner_response_bundle_zip" -and
            -not [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusSemanticPreflightRun" $true) -and
            -not [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusReadyForAcceptanceCandidate" $true) -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusPendingOwnerPacketCount" 0) -eq 3 -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusRemainingMissingFileCount" 0) -eq 9 -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusRemainingBlockingReasonCount" 0) -eq 11 -and
            -not [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusAcceptanceRun" $true) -and
            -not [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusRealHostProjectEvidenceAccepted" $true) -and
            [bool](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusManifestHashMatchesCanonical" $false) -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOwnerReturnBundleStatusProbeCaseCount" 0) -eq 5 -and
            ...
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionHandoffExportOperatorActionQueueItemStatusCommandCount" 0) -eq 3 -and
            ...
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueOwnerResponseBundleStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueOwnerResponseBundleStatusCommand" "")).Contains("-OwnerResponseBundleDir") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueOwnerResponseBundleZipStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueOwnerResponseBundleZipStatusCommand" "")).Contains("-OwnerResponseBundleZipPath") -and
            (Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueOwnerResponseBundleDirEnvironmentVariable" "") -eq "AITESTPILOT_OWNER_RESPONSE_BUNDLE_DIR" -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueItemStatusCommandCount" 0) -eq 3 -and
            [bool]$releaseRiskPolicyManifest.productionExternalEvidenceActionQueueProbeAccepted -and
            (Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueueProbeOwnerResponseBundleDirEnvironmentVariable" "") -eq "AITESTPILOT_OWNER_RESPONSE_BUNDLE_DIR" -and
            ...
            [int]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightCaseCount -eq 12 -and
            [int]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightCandidateCaseCount -eq 4 -and
            [int]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightRejectedCaseCount -eq 8 -and
            ...
            [bool]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightUnsafeOwnerResponseBundleZipRejected -and
            [bool]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightExtraPayloadBundleRejected -and
            [bool]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightNestedPayloadBundleZipRejected -and
            [int]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightOwnerResponseBundleZipCaseCount -eq 6 -and
            [int]$releaseRiskPolicyManifest.productionExternalEvidenceSemanticPreflightOwnerResponseBundleZipSafeCaseCount -eq 5 -and
            ...
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePendingOwnerResponseBundleStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePendingOwnerResponseBundleStatusCommand" "")).Contains("-OwnerResponseBundleDir") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePendingOwnerResponseBundleZipStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePendingOwnerResponseBundleZipStatusCommand" "")).Contains("-OwnerResponseBundleZipPath") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePostDispatchOwnerResponseBundleStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePostDispatchOwnerResponseBundleStatusCommand" "")).Contains("-OwnerResponseBundleDir") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePostDispatchOwnerResponseBundleZipStatusCommand" "")).Contains("Invoke-AITestPilotProductionExternalEvidenceOwnerReturnBundleStatus.ps1") -and
            ([string](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePostDispatchOwnerResponseBundleZipStatusCommand" "")).Contains("-OwnerResponseBundleZipPath") -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePendingItemStatusCommandCount" 0) -eq 3 -and
            [int](Get-JsonValue $releaseRiskPolicyManifest "productionExternalEvidenceActionQueuePostDispatchItemStatusCommandCount" 0) -eq 3 -and
