...
$requiredZipEntries = @(
    ...
    "operator-actions\production-external-evidence-owner-return-bundle-status-manifest.json",
    "operator-actions\production-external-evidence-owner-return-bundle-status.md",
    "operator-actions\production-external-evidence-owner-return-bundle-status-probe-manifest.json",
    "operator-actions\production-external-evidence-owner-return-bundle-status-probe.md",
