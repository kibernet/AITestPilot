...
$requiredDocStrings = @(
    ...
    [ordered]@{ file = "README.md"; pattern = "113 semantic field checks"; label = "release evidence index 113-field coverage count" },
    ...
    [ordered]@{ file = "docs/ci-release-pipeline.md"; pattern = "113 semantic fields"; label = "field coverage pipeline count" },
    ...
    [ordered]@{ file = "docs/architecture.md"; pattern = "113 semantic fields"; label = "field coverage architecture count" },
    ...
    [ordered]@{ file = "docs/roadmap.md"; pattern = "113 semantic fields"; label = "roadmap field coverage count" },
