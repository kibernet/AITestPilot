...
$requiredDocStrings = @(
    ...
    [ordered]@{ file = "README.md"; pattern = 'latest big node is `production_handoff_owner_route_map`'; label = "progress notification final route map refresh" },
    [ordered]@{ file = "README.md"; pattern = "complete owner response bundle zip, partial zip, semantic-bad zip, arbitrary single top-level wrapper zip, and unsafe zip"; label = "owner response bundle zip case set" },
    [ordered]@{ file = "README.md"; pattern = "caseCount=10"; label = "semantic preflight case count target" },
    [ordered]@{ file = "README.md"; pattern = "completeCandidateCaseCount=4"; label = "semantic preflight candidate case count target" },
    [ordered]@{ file = "README.md"; pattern = "rejectedCaseCount=6"; label = "semantic preflight rejected case count target" },
    [ordered]@{ file = "README.md"; pattern = "checkCount=12"; label = "semantic preflight check count target" },
    [ordered]@{ file = "README.md"; pattern = "ownerResponseBundleZipCaseCount=5"; label = "owner response bundle zip case count target" },
    ...
    [ordered]@{ file = "README.md"; pattern = "74 semantic field checks"; label = "release evidence index 74-field coverage count" },
    ...
    [ordered]@{ file = "docs/ci-release-pipeline.md"; pattern = "74 semantic fields"; label = "field coverage pipeline count" },
    ...
    [ordered]@{ file = "docs/architecture.md"; pattern = "74 semantic fields"; label = "field coverage architecture count" },
    ...
    [ordered]@{ file = "docs/roadmap.md"; pattern = "74 semantic fields"; label = "roadmap field coverage count" },
