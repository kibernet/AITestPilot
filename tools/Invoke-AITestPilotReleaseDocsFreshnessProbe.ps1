...
$requiredDocStrings = @(
    ...
    [ordered]@{ file = "README.md"; pattern = "124 semantic field checks"; label = "release evidence index 124-field coverage count" },
    ...
    [ordered]@{ file = "docs/architecture.md"; pattern = "124 semantic fields"; label = "field coverage architecture count" },
    ...
    [ordered]@{ file = "docs/roadmap.md"; pattern = "124 semantic fields"; label = "roadmap field coverage count" },
