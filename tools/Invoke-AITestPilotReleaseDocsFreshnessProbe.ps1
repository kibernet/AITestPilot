...
$requiredDocStrings = @(
    ...
    [ordered]@{ file = "README.md"; pattern = "84 semantic field checks"; label = "release evidence index 84-field coverage count" },
    ...
    [ordered]@{ file = "docs/ci-release-pipeline.md"; pattern = "84 semantic fields"; label = "field coverage pipeline count" },
    ...
    [ordered]@{ file = "docs/architecture.md"; pattern = "84 semantic fields"; label = "field coverage architecture count" },
    ...
    [ordered]@{ file = "docs/roadmap.md"; pattern = "84 semantic fields"; label = "roadmap field coverage count" },
