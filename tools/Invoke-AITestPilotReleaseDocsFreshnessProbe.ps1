...
$requiredDocStrings = @(
    ...
    [ordered]@{ file = "README.md"; pattern = "129 semantic field checks"; label = "release evidence index 129-field coverage count" },
    ...
    [ordered]@{ file = "docs/ci-release-pipeline.md"; pattern = "129 semantic fields"; label = "field coverage pipeline count" },
    ...
    [ordered]@{ file = "docs/architecture.md"; pattern = "129 semantic fields"; label = "field coverage architecture count" },
    ...
    [ordered]@{ file = "docs/roadmap.md"; pattern = "129 semantic fields"; label = "roadmap field coverage count" },
