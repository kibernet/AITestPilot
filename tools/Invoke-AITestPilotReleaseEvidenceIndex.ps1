...
function New-ReleaseEvidenceFieldCoverage {
    ...
    $checks += New-FieldCoverageCheck "production-external-evidence-semantic-preflight-probe-manifest.json" "caseCount" "int-eq" 10 "semantic preflight covers all expected cases"
    ...
    $checks += New-FieldCoverageCheck "production-external-evidence-semantic-preflight-probe-manifest.json" "rejectedCaseCount" "int-eq" 6 "semantic preflight keeps six rejected cases"
